...
def test_chat_internlm_chat_7b(config):
    result, chat_log = commondLineTest(config, 'internlm-chat-7b', 'turbomind', None)
...
def test_chat_internlm_chat_20b(config):
    result, chat_log = commondLineTest(config, 'internlm-chat-20b', 'turbomind', None)
...
def test_chat_Qwen_7B_Chat(config):
    result, chat_log = commondLineTest(config, 'Qwen-7B-Chat', 'turbomind', None)
...
def test_chat_Qwen_14B_Chat(config):
    result, chat_log = commondLineTest(config, 'Qwen-14B-Chat', 'turbomind', None)
...
def test_chat_Baichuan2_7B_Chat_inner_w4(config):
    result, chat_log = commondLineTest(config, 'Baichuan2-7B-Chat-inner-w4', 'turbomind', None)
...
def test_chat_CodeLlama_7b_hf(config):
    result, chat_log = commondLineTest(config, 'CodeLlama-7b-hf', 'turbomind', None)
